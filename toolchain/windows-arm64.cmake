...
set(TARGET_TRIPLE aarch64-pc-win32-msvc)
...
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/windows kits/10/lib/10.0.26100.0/um/arm64\"")
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/windows kits/10/lib/10.0.26100.0/ucrt/arm64\"")
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/vc/tools/msvc/14.44.35207/lib/onecore/arm64\"")
...
set(CMAKE_C_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -I\"${CMAKE_SYSROOT}/windows kits/10/bin/arm64/include\"")
...
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/windows kits/10/lib/10.0.26100.0/um/arm64\"")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/windows kits/10/lib/10.0.26100.0/ucrt/arm64\"")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -L\"${CMAKE_SYSROOT}/vc/tools/msvc/14.44.35207/lib/arm64\"")
...
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} -I\"${CMAKE_SYSROOT}/windows kits/10/bin/arm64/include\"")
...
list(APPEND CMAKE_FIND_ROOT_PATH "${CMAKE_SYSROOT}/third_party/arm64/lib/cmake")
