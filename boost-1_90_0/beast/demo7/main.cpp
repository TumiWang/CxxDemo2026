...
int main()
{
    ...
    std::make_shared<Https>(boost::asio::make_strand(context))->DoGet("www.baidu.com", default_https_port_, "/");

    std::make_shared<Https>(boost::asio::make_strand(context))->DoGet("cmake.org", default_https_port_, "/cmake/help/latest/index.html");
